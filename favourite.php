...
<!--            <div id="header" class="update-location-div">
            ...
            while ($subcat_res = mysql_fetch_array($subcat_query)) {
                ...
                if ($subcat_res[userid] != $loginid) {
                    ...
                    <div class="job-thumb favourite-box">
                        ...
                        <?php if ($subcat_res[type] == 'L') { ?>
                            ...
                            <div class="favourite-dtl">
                                ...
                                <!-- <span class="km"><?php echo number_format($finaldist, 1) . ' km' ?></span> -->
                                    </a></h3><p class="red">  <?php if ($subcat_res[budget] != '0' && $subcat_res[duration] != '0' && $subcat_res[type] == 'F') {
                                    echo "Interested if";
                        ...
                        <a <?php if ($subcat_res[budget] != '0' && $subcat_res[duration] != '0' && $subcat_res[type] == 'F') { ?> onClick="location.href = 'favtomeet.php?id=<?php echo $favworkid ?>'"<?php } else if ($subcat_res[type] == 'L') {
                         echo "Liked";
                     } else {
                         echo "Interested";
                     }
        ...
        <?php } ?>
                                ...
                                <p style="line-height: 24px;"><span class="grey" style="font-size:12px;">Nationality:</span> 
                                    <?php if ($about_res[nationality] != "") {
                                        echo getNationality($about_res[nationality]) ?>  <br><?php } ?>
                                    <span class="grey" style="font-size:12px;">Area of Residence: </span><strong class="black">
        <?php if ($about_res[area] != "") {
            echo '' . $about_res[area] ?> <?php } ?> </strong>
                                    <br>
                                    <span class="grey" style="font-size:10px;">Gender: </span>
                                    <span style="font-size:12px;"><?php if ($about_res[gender] != "") {
            echo '' . $about_res[gender] ?><?php } ?> </span> 
                                    <span class="grey" style="font-size:10px;">MBTI  Personality: </span>
                                    <span style="font-size:12px;">	<?php if ($about_res[mbti] != "") {
            echo '' . getMBTI($about_res[mbti]) ?></span> <?php } ?> <br>
                    <?php if ($about_res[education] != "") {
                        echo '<span class="grey" style="font-size:12px;">Education: </span>' . getEducation($about_res[education]) ?>  <?php } ?>   <br>
                    <?php if ($about_res[degree] != "") {
                        echo '<span class="grey" style="font-size:12px;">Degree: </span>' . getDegree($about_res[degree]) ?><?php } ?> 
                                    <br>
                    <?php if ($about_res[jobtitle] != "") {
    ...
    ?>
                ...
                <?php } ?>					
                                ...
                                <div class="favourite-dtl">
                                        <h3><a href="viewclient.php?id=<?php echo $userid ?>&req=fav"><?php echo $about_res[first_name] . ' ' . $about_res[last_name] ?> <br> <span class="km"><?php echo number_format($finaldist, 1) . ' km' ?></span></h3></a><p class="red">Is interested <?php if ($subcat_res[budget] != '0' && $subcat_res[duration] != '0') {
                echo "if";
            } ?></p>
                                        <div class="rating-div">							
                <?php
                ...
                <?php if ($about_res[nationality] != "") {
                    echo getNationality($about_res[nationality]) ?>  <span class="grey pipe">I</span><?php } ?>
                <?php if ($about_res[area] != "") {
                    echo '<span class="grey">Area: </span>' . $about_res[area] ?> <span class="grey pipe">I</span><?php } ?> 
                <?php if ($about_res[gender] != "") {
                    echo '<span class="grey">Gender: </span>' . $about_res[gender] ?> <span class="grey pipe">I</span><?php } ?> 
                <?php if ($about_res[mbti] != "") {
                    echo '<span class="grey">MBTI: </span>' . getMBTI($about_res[mbti]) ?> <span class="grey pipe">I</span><?php } ?> 
                <?php if ($about_res[education] != "") {
                    echo '<span class="grey">Education: </span>' . getEducation($about_res[education]) ?>  <span class="grey pipe">I</span><?php } ?>   
                <?php if ($about_res[degree] != "") {
                    echo '<span class="grey">Degree: </span>' . getDegree($about_res[degree]) ?><span class="grey pipe">I</span><?php } ?> 
                <?php if ($about_res[jobtitle] != "") {
