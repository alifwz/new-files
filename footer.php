...
<style>
                ...
                <div class="menu-main-sub">
                    ...
                    <div class="menu-links">
                        <ul>
                            ...
                            <?php if ($loginid != "") { ?>
                                <li><a href="make-profile.php"><span class="menu-icon"><img src="images/icon-upload-profile.png" alt="Profile" /></span> Edit Profile </a></li>
    ...
    <div class="bottom-holder">
        ...
        <div class="sub-bottom-bar">
            ...
            <form class="photo-job-video-form" style="display:none" name="upload" id="imageform" action='ajaximage.php' method="post" enctype="multipart/form-data">
                    <div class="photo-job-video">
                        <div class="row" style="margin-bottom: 0px;">
                            ...
                            <?php
                        } else if ($incomplete_profile) {
                            ?>
                            <div class="col-4 uploader"><a data-type="postanimage.php" href="javascript:void(0);" class="border_post incompleteprofile">Post a photo</a></div>
                            <div class="col-4"><a data-type="post-a-job.php" href="javascript:void(0);" class="border_post incompleteprofile">Post a job</a></div>
                            <div class="col-4 uploader"><a data-type="postvideo" href="javascript:void(0);" class="border_post incompleteprofile">Post a Video</a></div>
                        <?php } else {
                            ?>
                        ...
                        <div class="for gotpass-main">
                            ...
                            <div class="form-group">
                                <select style="
                                        font-size: 15px;
                                        height: 40px;
                                        "  name="category" id="post-video-category" required class="form-control inputbg">
                            ...
                            <div class="form-group">
                                <select style="
                                        font-size: 15px;
                                        height: 40px;
                                        "  name="subcategory" required id="post-video-subcategory" class="form-control inputbg"></select>
                            </div>
                            <div class="form-group">
